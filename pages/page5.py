...
def update_ball_position(correct):
    ...
    # Überprüfen, ob ein Tor oder Gegentor erzielt wurde
    if st.session_state.ball_position == 0 or st.session_state.ball_position == 6:
        reset_ball_position()

# Funktion zur Zurücksetzung der Ballposition in die Mitte
def reset_ball_position():
    st.session_state.ball_position = 3  # Startposition in der Mitte
